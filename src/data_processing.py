...
for dataset in ('drowsy', 'active'):
    ...
    print(f"Cargando {len(image_paths)} imágenes del dataset {dataset}...")
    ...
    print(f"Procesando imágenes del dataset {dataset}...")
    ...
    for img_path in tqdm(image_paths):
        ...
        if face_norm is not None:
            ...
            # print(f"Face found in {img_name} ✅") # Optional: reduce noise
        else:
